						...
						<div class="row text-center text-lg-start">
								...
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Kaiko Sareta Ankoku Heishi</h5>
										<h5 class="h6 card-title  text-center" style="color: #00FFFF">Thời
											lượng: 12 tập</h5>
										<hr>
										<a href="#" class="btn btn-primary mb-3 ml-3 float-end"
											style="width: 120px; margin-right: 20px"><i
											class="fa-solid fa-share"></i>&nbsp;Share</a> <a href="#"
											class="btn btn-primary float-end"
											style="width: 120px; margin-right: 15px"><i
											class="fa-solid fa-thumbs-down"></i> &nbsp;Bỏ thích</a>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-4 col-6">
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Saikyou Onmyouji no Isekai
											Tenseiki</h5>
										<h5 class="h6 card-title  text-center" style="color: #00FFFF">Thời
											lượng: 12 tậpr</h5>
										<hr>
							...
							<div class="col-lg-4 col-md-4 col-6">
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Kage no Jitsuryokusha ni
											Naritakute!</h5>
										<h5 class="h6 card-title  text-center" style="color: #00FFFF">Thời
											lượng: 20 tâp</h5>
										<hr>
							...
							<div class="col-lg-4 col-md-4 col-6 mt-4">
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Conam thám tử lừng danh</h5>
										<h5 class="h6 card-title  text-center" style="color: #00FFFF">Thời
											lượng: 1245 tập</h5>
										<hr>
										<a href="#" class="btn btn-primary mb-3 ml-3 float-end"
							...
							<div class="col-lg-4 col-md-4 col-6 mt-4">
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Tensei Oujo to Tensai Reijou no
											Mahou</h5>
										<h5 class="h6 card-title  text-center" style="color: #00FFFF">Thời
											lượng: 12 tập</h5>
										<hr>
							...
							<div class="col-lg-4 col-md-4 col-6 mt-4">
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Renai Flops</h5>
										<h5 class="h6 card-title  text-center" style="color: #00FFFF">Thời
											lượng: 12 tập</h5>
										<hr>
										<a href="#" class="btn btn-primary mb-3 ml-3 float-end"
							...
							<div class="col-lg-4 col-md-4 col-6 mt-4 mb-5">
								<div class="card"
									...
									<div class="card-body">
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Isekai Nonbiri Nouka</h5>
										<h5 class="h6 card-title text-center" style="color: #00FFFF">Thời
											lượng: 13 tập</h5>
										<hr>
										<a href="#" class="btn btn-primary mb-3 ml-3 float-end"
							...
							<div class="col-lg-4 col-md-4 col-6 mt-4 mb-5">
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Thiên sứ nhà bên</h5>
										<h5 class="h6 card-title text-center" style="color: #00FFFF">Thời
											lượng: 13 tập</h5>
										<hr>
										<a href="#" class="btn btn-primary mb-3 ml-3 float-end"
							...
							<div class="col-lg-4 col-md-4 col-6 mt-4 mb-5">
								<div class="card"
									...
									<div class="card-body">
										...
										<h5 class="h5 card-title text-center text-uppercase"
											style="color: #ccff99;">Maou Gakuin no Futekigousha</h5>
										<h5 class="h6 card-title text-center" style="color: #00FFFF">Thời
											lượng: 13 tập</h5>
										<hr>
										<a href="#" class="btn btn-primary mb-3 ml-3 float-end"
